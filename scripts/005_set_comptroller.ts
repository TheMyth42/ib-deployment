...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  // const priceOracleAddress = (await deployments.get('ChainlinkOracle')).address;
  ...
  // await execute('Comptroller', { from: deployer }, '_setGuardian', guardian);
};
export default func;
func.tags = ['SetupComptroller'];
func.dependencies = ['Comptroller', 'ChainlinkOracle'];
